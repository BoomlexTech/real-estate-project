    ...
    <section className="py-20 px-4" style={{ background: 'var(--bg-warm-tint)' }}>
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-sm max-w-xl" style={{ color: 'var(--text-primary)' }}>
          ...
          <div className="flex gap-2 self-end sm:absolute sm:top-0 sm:right-0">
            <button
              onClick={prev}
              disabled={!canPrev}
              className="w-11 h-11 rounded-full flex items-center justify-center t-heading transition disabled:opacity-30"
