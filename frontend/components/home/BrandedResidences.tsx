            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col lg:grid lg:grid-cols-3 lg:gap-16 lg:items-start">
                    ...
                    >
                        ...
                        <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-light t-heading leading-[1.08] mb-5">
                            Branded Residences<br />
                            <span style={{ color: '#C9A96E' }}>In Dubai</span>
                        </h2>
                        <p className="text-sm leading-[1.85] tracking-wide mb-8" style={{ color: 'var(--text-primary)' }}>
