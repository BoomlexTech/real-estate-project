        ...
        {leftStats.map((s, i) => (
          <div key={s.label}>
            <div className="flex flex-col items-center text-center py-4 px-2">
              ...
              <span className="text-[10px] tracking-[0.14em] uppercase" style={{ color: 'var(--text-primary)' }}>{s.label}</span>
            </div>
        ...
        <div className="property-card-wrapper">
          <div className="property-card-content bg-page p-8 sm:p-10">
            ...
            <div className="text-center mb-10">
              ...
              <h2 className="font-serif text-3xl sm:text-4xl font-light mb-2 leading-tight" style={{ color: 'var(--text-primary)' }}>
                Find Your Ideal Property
              </h2>
              <p className="text-sm tracking-[0.04em] max-w-2xl mx-auto" style={{ color: 'var(--text-primary)' }}>
