...
export default function PropertyCard({ property }: PropertyCardProps) {
  return (
    <Link
      ...
      onClick={() => trackEvent('property_card_click', { property_id: property.id, property_title: property.title, property_type: property.type, property_status: property.status, price: property.price, emirate: property.emirate, bedrooms: property.bedrooms })}
    >
          ...
          {property.agent && (
            ...
            >
              <Link
                ...
                onClick={(e) => { e.stopPropagation(); trackEvent('agent_profile_click', { agent_id: property.agent!.id, agent_name: property.agent!.name, source: 'property_card' }); }}
              >
                <div
              ...
              <div className="flex gap-2">
                <a
                  ...
                  onClick={(e) => { e.stopPropagation(); trackEvent('whatsapp_click', { source: 'property_card', property_id: property.id, agent_name: property.agent!.name }); }}
                >
