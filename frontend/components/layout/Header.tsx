      ...
      >
        ...
        >
          <div className="flex items-center gap-6">
            <a href="https://faq.whatsapp.com/5913398998672934" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 transition-colors" style={{ color: 'rgba(255,255,255,0.42)', fontSize: '0.6875rem', letterSpacing: '0.06em' }}
