      ...
      >
        ...
        <div
          ...
          style={{
            ...
            background: isDark ? 'rgba(10,14,26,0.55)' : 'rgba(244,240,232,0.6)',
          }}
        >
          <div className="flex items-center gap-7">
            <a href="https://wa.me/971547093295?text=I'm%20interrested%20about%20this%20property" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 transition-colors" style={{ color: isDark ? 'rgba(255,255,255,0.6)' : 'rgba(10,14,26,0.55)', fontSize: '0.75rem', letterSpacing: '0.06em' }}
              onMouseEnter={e => (e.currentTarget.style.color = '#25D366')}
              onMouseLeave={e => (e.currentTarget.style.color = isDark ? 'rgba(255,255,255,0.6)' : 'rgba(10,14,26,0.55)')}
            >
            ...
            <a href="tel:+971547093295" className="flex items-center gap-2 transition-colors" style={{ color: isDark ? 'rgba(255,255,255,0.6)' : 'rgba(10,14,26,0.55)', fontSize: '0.75rem', letterSpacing: '0.06em' }}
