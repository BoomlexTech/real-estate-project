      ...
      >
        ...
        >
          <div className="flex items-center gap-6">
            <a href="https://wa.me/971547093295?text=I'm%20interrested%20about%20this%20property" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 transition-colors" style={{ color: 'rgba(255,255,255,0.42)', fontSize: '0.6875rem', letterSpacing: '0.06em' }}
            ...
            <a href="tel:+971547093295" className="flex items-center gap-1.5 transition-colors" style={{ color: 'rgba(255,255,255,0.42)', fontSize: '0.6875rem', letterSpacing: '0.06em' }}
              onMouseEnter={e => (e.currentTarget.style.color = 'rgba(255,255,255,0.8)')}
              onMouseLeave={e => (e.currentTarget.style.color = 'rgba(255,255,255,0.42)')}
            >
          ...
          <div className="flex items-center gap-5">
            <div className="flex items-center gap-1.5 cursor-pointer transition-colors" style={{ color: 'rgba(255,255,255,0.38)', fontSize: '0.6875rem', letterSpacing: '0.08em' }}>
