  ...
  return (
    <div>
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold" style={{ color: '#e6edf3' }}>Property Inquiries</h1>
                ...
                {inquiries.map((inq) => {
                  ...
                  return (
                    <tr key={inq._id} style={{ borderBottom: '1px solid #2e3446' }}>
                      <td className="px-4 py-3 font-medium whitespace-nowrap" style={{ color: '#e6edf3' }}>{inq.name}</td>
                      <td className="px-4 py-3" style={{ color: '#8892a4' }}>{inq.email}</td>
                      <td className="px-4 py-3 whitespace-nowrap" style={{ color: '#8892a4' }}>{inq.phone || '—'}</td>
                      <td className="px-4 py-3 whitespace-nowrap" style={{ color: '#c9d1d9' }}>{inq.property?.title || '—'}</td>
                      <td className="px-4 py-3 whitespace-nowrap" style={{ color: '#c9d1d9' }}>{inq.agent?.name || '—'}</td>
